...
describe('Mobile navigation', () => {
  ...
  it('navigates to the correct pages', () => {
    const navLinks = [
      ...
      { href: '/challenges/today', activePath: '/today', icon: '/icons/day-tasks.png' },
      { href: '/add-task', activePath: '/add-task', icon: '/icons/add-task.png' },
      { href: '/days', activePath: '/days', icon: '/icons/history.png' },
      { href: '/avatars', activePath: '/avatars', icon: '/icons/to-avatars.png' },
    ];
